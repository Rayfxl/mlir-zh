...
- Symbol
  - [Defining or declaring a Symbol](https://mlir.llvm.org/docs/SymbolsAndSymbolTables/#defining-or-declaring-a-symbol)
- Symbol Table
  - [Referencing a Symbol](https://mlir.llvm.org/docs/SymbolsAndSymbolTables/#referencing-a-symbol)
  - [Manipulating a Symbol](https://mlir.llvm.org/docs/SymbolsAndSymbolTables/#manipulating-a-symbol)
...
A `Symbol` is a named operation that resides immediately within a region that defines a [`SymbolTable`](https://mlir.llvm.org/docs/SymbolsAndSymbolTables/#symbol-table). The name of a symbol *must* be unique within the parent `SymbolTable`. This name is semantically similar to an SSA result value, and may be referred to by other operations to provide a symbolic link, or use, to the symbol. An example of a `Symbol` operation is [`func.func`](https://mlir.llvm.org/docs/Dialects/Builtin/#func-mlirfuncop). `func.func` defines a symbol name, which is [referred to](https://mlir.llvm.org/docs/SymbolsAndSymbolTables/#referencing-a-symbol) by operations like [`func.call`](https://mlir.llvm.org/docs/Dialects/Func/#funccall-callop).
...
- A
  ...
  attribute named ‘SymbolTable::getSymbolAttrName()’(
...
- An optional
  ...
  attribute named ‘SymbolTable::getVisibilityAttrName()’(
  ...
  - This attribute defines the [visibility](https://mlir.llvm.org/docs/SymbolsAndSymbolTables/#symbol-visibility) of the symbol, or more specifically in-which scopes it may be accessed.

- No SSA results

  - Intermixing the different ways to `use` an operation quickly becomes unwieldy and difficult to analyze.

- Whether this operation is a declaration or definition (
