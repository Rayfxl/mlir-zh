...
- [Source Locations](https://mlir.llvm.org/docs/Diagnostics/#source-locations)
- Diagnostic Engine
  - [Constructing a Diagnostic](https://mlir.llvm.org/docs/Diagnostics/#constructing-a-diagnostic)
- Diagnostic
  - [Appending arguments](https://mlir.llvm.org/docs/Diagnostics/#appending-arguments)
  - [Attaching notes](https://mlir.llvm.org/docs/Diagnostics/#attaching-notes)
  - [Managing Metadata](https://mlir.llvm.org/docs/Diagnostics/#managing-metadata)
- [InFlight Diagnostic](https://mlir.llvm.org/docs/Diagnostics/#inflight-diagnostic)
- Diagnostic Configuration Options
  - [Print Operation On Diagnostic](https://mlir.llvm.org/docs/Diagnostics/#print-operation-on-diagnostic)
  - [Print StackTrace On Diagnostic](https://mlir.llvm.org/docs/Diagnostics/#print-stacktrace-on-diagnostic)
...
## Diagnostic Engine [¶](https://mlir.llvm.org/docs/Diagnostics/#diagnostic-engine)
...
As stated above, the `DiagnosticEngine` holds the core API for diagnostic emission. A new diagnostic can be emitted with the engine via `emit`. This method returns an [InFlightDiagnostic](https://mlir.llvm.org/docs/Diagnostics/#inflight-diagnostic) that can be modified further.
...
## Diagnostic [¶](https://mlir.llvm.org/docs/Diagnostics/#diagnostic)
...
- [Source Location](https://mlir.llvm.org/docs/Diagnostics/#source-locations)
- Severity Level
...
Now that [Diagnostics](https://mlir.llvm.org/docs/Diagnostics/#diagnostic) have been explained, we introduce the `InFlightDiagnostic`, an RAII wrapper around a diagnostic that is set to be reported. This allows for modifying a diagnostic while it is still in flight. If it is not reported directly by the user it will automatically report when destroyed.
...
## Diagnostic Configuration Options [¶](https://mlir.llvm.org/docs/Diagnostics/#diagnostic-configuration-options)
...
## Common Diagnostic Handlers [¶](https://mlir.llvm.org/docs/Diagnostics/#common-diagnostic-handlers)

To interface with the diagnostics infrastructure, users will need to register a diagnostic handler with the [`DiagnosticEngine`](https://mlir.llvm.org/docs/Diagnostics/#diagnostic-engine). Recognizing the many users will want the same handler functionality, MLIR provides several common diagnostic handlers for immediate use.
...
#### Filtering Locations [¶](https://mlir.llvm.org/docs/Diagnostics/#filtering-locations)
...
Similarly to the [SourceMgr Diagnostic Handler](https://mlir.llvm.org/docs/Diagnostics/#sourcemgr-diagnostic-handler), this handler can be added to any tool via the following:
